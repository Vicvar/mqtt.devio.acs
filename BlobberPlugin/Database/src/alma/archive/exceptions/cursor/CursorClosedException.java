...
// $Log: CursorClosedException.java,v $
...
package alma.archive.exceptions.cursor;

import alma.archive.exceptions.ArchiveCursorException;

/**
 * @author hmeuss
 *
 */
public class CursorClosedException extends ArchiveCursorException {
	 ...
	 * @param cause
	 */
	public CursorClosedException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
}
