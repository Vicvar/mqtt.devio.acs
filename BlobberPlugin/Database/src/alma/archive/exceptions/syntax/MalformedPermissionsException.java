...
// $Log: MalformedPermissionsException.java,v $
 ...
 *
 */
public class MalformedPermissionsException extends ArchiveSyntaxException {

	/**
	 * 
	 */
	public MalformedPermissionsException() {
		super();
	 ...
	 * @param message
	 */
	public MalformedPermissionsException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public MalformedPermissionsException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public MalformedPermissionsException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
}
