...
// $Log: UndefinedNamespaceException.java,v $
 ...
 *
 */
public class UndefinedNamespaceException extends ArchiveGeneralException {

	/**
	 * 
	 */
	public UndefinedNamespaceException() {
		super();
	 ...
	 * @param message
	 */
	public UndefinedNamespaceException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public UndefinedNamespaceException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public UndefinedNamespaceException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
}
