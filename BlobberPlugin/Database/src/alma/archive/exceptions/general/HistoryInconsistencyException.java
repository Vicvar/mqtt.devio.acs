...
// $Log: HistoryInconsistencyException.java,v $
 ...
 *
 */
public class HistoryInconsistencyException extends ArchiveGeneralException {

	/**
	 * 
	 */
	public HistoryInconsistencyException() {
		super();
	 ...
	 * @param message
	 */
	public HistoryInconsistencyException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public HistoryInconsistencyException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public HistoryInconsistencyException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
}
