...
// $Log: RoleAlreadyExistsException.java,v $
...
package alma.archive.exceptions.user;


import alma.archive.exceptions.ArchiveUserException;

/**
 * @author hmeuss
 *
 */
public class RoleAlreadyExistsException extends ArchiveUserException {
