...
// $Log: ArchiveSyntaxException.java,v $
 ...
 *
 */
public class ArchiveSyntaxException extends ArchiveException {
	
	/**
	 * 
	 */
	public ArchiveSyntaxException() {
		super();
	 ...
	 * @param message
	 */
	public ArchiveSyntaxException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public ArchiveSyntaxException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public ArchiveSyntaxException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
}
