 ...
 */
public class TMCSyncDumper extends TMCDumper implements Runnable {
    /** The logger */
    private static final Logger log = Logger.getLogger(TMCSyncDumper.class);
     ...
     */
    public TMCSyncDumper(String channelName, List<String> dataList, TMCProperties tmcProperties, TMCProducerStats writerStats, TMCTimeStatistic diskWriteTime, Date startupDate) {
